...
class Singleton(object):
    ...
    def get_test_flag(self):
        ...
        if len(flags.FLAGS.__dict__.keys()) <= 2:
            ...
            flags.DEFINE_integer("num_epoches", 1000,
                                 "Number of training epochs (default: 200)")
            flags.DEFINE_integer(
                "evaluate_every", 500, "Evaluate model on dev set after this many steps (default: 100)")
            flags.DEFINE_integer(
    ...
    def get_rnn_flag(self):
        ...
        if len(flags.FLAGS.__dict__.keys()) <= 2:
            ...
            flags.DEFINE_string('data_dir', 'data/wiki', 'wiki')
            flags.DEFINE_string(
                'pooling', 'max', 'max pooling or attentive pooling')
            flags.DEFINE_string('attention', 'tradition', 'attention strategy')
